...
mips_constant_41 :  .word   3
mips_constant_42 :  .word   2
mips_constant_43 :  .word   0
mips_constant_44 :  .word   0
mips_constant_45 :  .word   1
mips_constant_46 :  .word   4
mips_constant_47 :  .word   1
mips_constant_48 :  .word   4
mips_constant_49 :  .word   3
mips_constant_50 :  .word   1
...
lw $t1, 88($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_16
seq $t2, $t0, $t1
...
bnez $t0, is_voidlabel_de_cil_unique25
lw $t0, mips_constant_44   # nos pidieron poner la variable con nombre mips_constant_44
sw $t0, 92($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_17
j endlabel_de_cil_unique26
is_voidlabel_de_cil_unique25:
lw $t0, mips_constant_45   # nos pidieron poner la variable con nombre mips_constant_45
sw $t0, 92($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_17
endlabel_de_cil_unique26:
...
lw $a2, 60($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_9
jal function_substr_at_String
...
sw $t0, 112($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_22
...
move $t5, $a0
lw $a0, mips_constant_49   # nos pidieron poner la variable con nombre mips_constant_49
sll $a0, $a0, 2
li $v0, 9
syscall
...
jal function__method_con_at_Object
...
lw $a0, 120($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_24
lw $a1, 112($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_22
lw $a2, 116($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_23
jal function_substr_at_String
...
lw $a1, 96($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_18
move $t0, $s0   # nos pidieron poner la variable con nombre param_function_main_at_Main_self_0
lw $t1, 4($t0)
lw $t2,24($t1)
jalr $t2
sw $v0, 152($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_32
lw $t0, 152($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_32
...
lw $a0, 152($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_32
...
sw $t0, 156($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_33
move $a0, $s0   # nos pidieron poner la variable con nombre param_function_main_at_Main_self_0
lw $a1, 156($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_33
move $t0, $s0   # nos pidieron poner la variable con nombre param_function_main_at_Main_self_0
lw $t1, 4($t0)
lw $t2,24($t1)
jalr $t2
sw $v0, 160($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_34
lw $t0, 160($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_34
sw $t0, 164($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_35
lw $v0, 164($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_35
lw $fp, 0($sp)
lw $ra, 4($sp)
lw $s0 8($sp)
lw $s1 12($sp)
