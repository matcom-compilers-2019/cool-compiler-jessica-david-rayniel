...
mips_constant_35 :  .word   0
mips_constant_36 :  .word   4
mips_constant_37 :  .word   10
mips_constant_38 :  .word   5
mips_constant_39 :  .word   9
mips_constant_40 :  .word   2
mips_constant_41 :  .word   2
mips_constant_42 :  .word   3
mips_constant_43 :  .word   0
mips_constant_44 :  .word   5
mips_constant_45 :  .word   4
...
mips_constant_53 :  .word   4
mips_constant_54 :  .word   5
mips_constant_55 :  .word   100
.text
...
sw $t0, 40($sp)   # nos pidieron poner la variable con nombre local_function__attr_con_at_Main_x_4
move $t0, $s0   # nos pidieron poner la variable con nombre param_function__attr_con_at_Main_self_0
lw $t1, mips_constant_36   # nos pidieron poner la variable con nombre mips_constant_36
sll $t1, $t1, 2
addu $t1, $t1 , $t0
lw $t2, 40($sp)   # nos pidieron poner la variable con nombre local_function__attr_con_at_Main_x_4
sw  $t2, 0($t1)
lw $t0, mips_constant_37   # nos pidieron poner la variable con nombre mips_constant_37
sw $t0, 48($sp)   # nos pidieron poner la variable con nombre local_function__attr_con_at_Main_internal_6
lw $t0, 48($sp)   # nos pidieron poner la variable con nombre local_function__attr_con_at_Main_internal_6
sw $t0, 44($sp)   # nos pidieron poner la variable con nombre local_function__attr_con_at_Main_y_5
move $t0, $s0   # nos pidieron poner la variable con nombre param_function__attr_con_at_Main_self_0
lw $t1, mips_constant_38   # nos pidieron poner la variable con nombre mips_constant_38
sll $t1, $t1, 2
addu $t1, $t1 , $t0
lw $t2, 44($sp)   # nos pidieron poner la variable con nombre local_function__attr_con_at_Main_y_5
sw  $t2, 0($t1)
...
move $a0, $t5
lw $a0, 68($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_11
...
sll $t1, $t1, 2
addu $t1, $t1 , $t0
lw $t2, 72($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_12
sw  $t2, 0($t1)
lw $t0, 76($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_13
...
lw $a0, 80($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_14
...
lw $v0, 116($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_23
lw $fp, 0($sp)
lw $ra, 4($sp)
lw $s0 8($sp)
lw $s1 12($sp)
