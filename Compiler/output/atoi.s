...
mips_constant_93 :  .word   2
mips_constant_94 :  .word   0
mips_constant_95 :  .word   678987
mips_constant_96 :  .word   4
mips_constant_97 :  .word   9
mips_constant_98 :  .word   1
mips_constant_99 :  .word   2
mips_constant_100 :  .word   0
.text
...
sll $t1, $t1, 2
addu $t1, $t1 , $t0
lw $t2, 56($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_8
sw  $t2, 0($t1)
lw $t0, 60($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_9
...
lw $t0, mips_constant_94   # nos pidieron poner la variable con nombre mips_constant_94
...
bnez $t0, is_void12label_de_cil_unique96
j end_dispatch12label_de_cil_unique97
is_void12label_de_cil_unique96:
move $t5, $a0
la $a0, mips_except_message_of_mine   # nos pidieron poner la variable con nombre mips_except_message_of_mine
li $v0 , 4
syscall
...
li $v0 , 10
syscall
end_dispatch12label_de_cil_unique97:
lw $a0, 60($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_9
...
sw $t0, 24($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_a_0
...
move $t5, $a0
lw $a0, mips_constant_96   # nos pidieron poner la variable con nombre mips_constant_96
sll $a0, $a0, 2
li $v0, 9
syscall
...
jal function__attr_con_at_A2I
sw $v0, 100($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_19
move $t5, $a0
...
move $a0, $t5
lw $a0, 92($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_17
jal function__method_con_at_A2I
sw $v0, 96($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_18
...
sll $t1, $t1, 2
addu $t1, $t1 , $t0
lw $t2, 96($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_18
sw  $t2, 0($t1)
lw $t0, 100($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_19
...
lw $t0, mips_constant_100   # nos pidieron poner la variable con nombre mips_constant_100
...
lw $t1, 80($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_14
seq $t2, $t0, $t1
...
bnez $t0, is_void13label_de_cil_unique98
j end_dispatch13label_de_cil_unique99
is_void13label_de_cil_unique98:
move $t5, $a0
la $a0, mips_except_message_of_mine   # nos pidieron poner la variable con nombre mips_except_message_of_mine
li $v0 , 4
syscall
...
li $v0 , 10
syscall
end_dispatch13label_de_cil_unique99:
lw $a0, 100($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_19
lw $a1, 84($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_15
lw $t0, 100($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_19
lw $t1, 4($t0)
lw $t2,28($t1)
jalr $t2
...
sw $t0, 64($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_b_10
move $a0, $s0   # nos pidieron poner la variable con nombre param_function_main_at_Main_self_0
lw $a1, 24($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_a_0
...
sw $t0, 108($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_21
move $a0, $s0   # nos pidieron poner la variable con nombre param_function_main_at_Main_self_0
lw $a1, 108($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_21
move $t0, $s0   # nos pidieron poner la variable con nombre param_function_main_at_Main_self_0
lw $t1, 4($t0)
lw $t2,24($t1)
jalr $t2
...
move $a0, $s0   # nos pidieron poner la variable con nombre param_function_main_at_Main_self_0
lw $a1, 64($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_b_10
move $t0, $s0   # nos pidieron poner la variable con nombre param_function_main_at_Main_self_0
lw $t1, 4($t0)
lw $t2,24($t1)
jalr $t2
...
sw $t0, 128($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_26
lw $v0, 128($sp)   # nos pidieron poner la variable con nombre local_function_main_at_Main_internal_26
lw $fp, 0($sp)
lw $ra, 4($sp)
lw $s0 8($sp)
lw $s1 12($sp)
