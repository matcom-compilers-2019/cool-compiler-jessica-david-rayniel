...
from code.front_end.lexer import tokens, main as lex_main
...
def p_expression_assignment(parse):
    """
    expression : ID IMPLICATION expression
    """
...
def p_let_expression(parse):
    ...
    parse[0] = our_ast.LetNode(parse[5], parse[2])
...
main(r'C:\Users\LsW\Desktop\Proyecto de Compilacion Jessica Quesada, David '
     r'Castillo, Rayniel Ramos,  y otros\docs\Compiler bibliography'
     r'\PyCOOLC-master\examples\io.cl')
